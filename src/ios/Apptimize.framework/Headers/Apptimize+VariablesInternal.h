...
extern void ABTVariableUpdateDefaultValue( const char *name, id defaultValue, struct _apptimize_variable_descriptor *desc );
...
#define _ApptimizeVariableInitializer(_name, _type, _subtype, ...) \
    static void __attribute__((constructor)) _atz_var_init ## _name () { \
        ...
        __VA_ARGS__; \
        ABTVariableUpdateDefaultValue( #_name, default_, &desc_ ); \
    }
